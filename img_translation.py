#build and train a conditional generative adversarial network (cGAN) called pix2pix
#that learns a mapping from input images to output images
...
#loads image files and outputs two image tensors
def load(image_file):
